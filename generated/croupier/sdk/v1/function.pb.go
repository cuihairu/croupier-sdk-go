...
const file_croupier_sdk_v1_function_proto_rawDesc = "" +
	"\n" +
	"\x1ecroupier/sdk/v1/function.proto\x12\x0fcroupier.sdk.v1\"\xfa\x01\n" +
	...
	"\x13com.croupier.sdk.v1B\rFunctionProtoP\x01Z9github.com/cuihairu/croupier/pkg/pb/croupier/sdk/v1;sdkv1\xa2\x02\x03CSX\xaa\x02\x0fCroupier.Sdk.V1\xca\x02\x0fCroupier\\Sdk\\V1\xe2\x02\x1bCroupier\\Sdk\\V1\\GPBMetadata\xea\x02\x11Croupier::Sdk::V1b\x06proto3"

var (
	file_croupier_sdk_v1_function_proto_rawDescOnce sync.Once
	file_croupier_sdk_v1_function_proto_rawDescData []byte
)

func file_croupier_sdk_v1_function_proto_rawDescGZIP() []byte {
	file_croupier_sdk_v1_function_proto_rawDescOnce.Do(func() {
		file_croupier_sdk_v1_function_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_croupier_sdk_v1_function_proto_rawDesc), len(file_croupier_sdk_v1_function_proto_rawDesc)))
	})
...
func file_croupier_sdk_v1_function_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_croupier_sdk_v1_function_proto_rawDesc), len(file_croupier_sdk_v1_function_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
