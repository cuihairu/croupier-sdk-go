...
func (c *Client) RegisterFunction(desc Function, h Handler) error {
	if c.l == nil {
		if c.cfg.LocalListen == "" {
			c.cfg.LocalListen = "127.0.0.1:0"
		}
		if c.cfg.ServiceID == "" {
			c.cfg.ServiceID = "svc-1"
		}
		c.l = &localServer{
	...
	if desc.Schema != nil {
		c.l.schemas[desc.ID] = desc.Schema
	}
	return nil
}
...
func (c *Client) Connect(ctx context.Context) error {
	...
	if c.l != nil {
		...
		if _, err := cli.RegisterLocal(ctx, &localv1.RegisterLocalRequest{ServiceId: c.l.serviceID, Version: c.l.version, RpcAddr: c.l.addr, Functions: fns}); err != nil {
